...
public class YandexMarketActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToCategoryBtn = findViewById(R.id.backToCategoryFromYandexMarket);


        backToCategoryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backToShopIntent = new Intent(YandexMarketActivity.this, ChooseShopActivity.class);
                startActivity(backToShopIntent);
            }
        });


        recyclerView = findViewById(R.id.recycle_menu_yandexmarket);
