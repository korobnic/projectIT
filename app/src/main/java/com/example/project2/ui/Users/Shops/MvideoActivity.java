...
public class MvideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToCategoryBtn = findViewById(R.id.backToCategoryFromMVideo);


        backToCategoryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backToShopIntent = new Intent(MvideoActivity.this, ChooseShopActivity.class);
                startActivity(backToShopIntent);
            }
        });


        recyclerView = findViewById(R.id.recycle_menu_MVideo);
