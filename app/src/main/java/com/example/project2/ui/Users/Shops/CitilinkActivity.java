...
public class CitilinkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToCategoryBtn = findViewById(R.id.backToCategoryFromCitilink);


        backToCategoryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backToShopIntent = new Intent(CitilinkActivity.this, ChooseShopActivity.class);
                startActivity(backToShopIntent);
            }
        });


        recyclerView = findViewById(R.id.recycle_menu_citilink);
